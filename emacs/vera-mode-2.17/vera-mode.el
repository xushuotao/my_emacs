...
;; Copyright (C) 1999-2005 Reto Zimmermann, Synopsys Inc.

;; Author:      Reto Zimmermann <reto@gnu.org>
;; Maintainer:  Reto Zimmermann <reto@gnu.org>
;; Version:     2.17
;; RCS:         $Id: vera-mode.el,v 2.21 2005/06/20 14:00:55 reto Exp reto $
;; Keywords:    languages vera
;; WWW:         http://opensource.ethz.ch/emacs/vera-mode.html
...
(defvar vera-mode-ext-syntax-table nil
...
(setq vera-mode-ext-syntax-table (copy-syntax-table vera-mode-syntax-table))
(modify-syntax-entry ?_ "w" vera-mode-ext-syntax-table)
...
Official distribution is at <http://opensource.ethz.ch/emacs/vera-mode.html>.
...
(defvar vera-font-lock-keywords
  (list
   ...
   (list vera-rvm-functions-regexp 1 'vera-font-lock-function-face)
   ;; highlight functions
